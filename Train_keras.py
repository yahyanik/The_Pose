...
def train1 (epoch = 120, layers_not_training =117, learning_rate = 0.0001, drop_out = 0.7, regular_fac = 0.1, num_to_reduce=32, imagesize = 320, batch_size = 32, num_threads = 10, num_gpus = 2):
